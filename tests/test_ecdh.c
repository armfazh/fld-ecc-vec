...
static void test0_rfc7748_x25519(const X_ECDH *x25519) {
  ...
  TEST(memcmp(output_coord0, shared, x25519->key_size) == 0);
  ...
  TEST(memcmp(output_coord1, shared, x25519->key_size) == 0);
  ...
  TEST(memcmp(alice_pk, alice_public, x25519->key_size) == 0);
  ...
  TEST(memcmp(bob_pk, bob_public, x25519->key_size) == 0);
  ...
  TEST(memcmp(alice_shared_secret, bob_shared_secret, x25519->key_size) == 0);
  TEST(memcmp(alice_shared_secret, shared_secret, x25519->key_size) == 0);
}
...
static void test0_rfc7748_x448(const X_ECDH *x448) {
  ...
  TEST(memcmp(output_coord0, shared, x448->key_size) == 0);
  ...
  TEST(memcmp(output_coord1, shared, x448->key_size) == 0);
  ...
  TEST(memcmp(alice_pk, alice_public, x448->key_size) == 0);
  ...
  TEST(memcmp(bob_pk, bob_public, x448->key_size) == 0);
  ...
  TEST(memcmp(alice_shared_secret, bob_shared_secret, x448->key_size) == 0);
  TEST(memcmp(alice_shared_secret, shared_secret, x448->key_size) == 0);
}

static void times(uint64_t n, argECDHX_Key k, uint8_t x_coordinate,
                  const X_ECDH *ecdh) {
...
static void test1_rfc7748_x25519(const X_ECDH *x25519) {
  ...
  times(1, k, 9, x25519);
  TEST(memcmp(k, k_1_times, x25519->key_size) == 0);
  times(1000, k, 9, x25519);
  TEST(memcmp(k, k_1000_times, x25519->key_size) == 0);
  // times(1000000,k,9,x25519);
  // TEST(memcmp(k, k_1000000_times,x25519->key_size)==0);
}
...
static void test1_rfc7748_x448(const X_ECDH *x448) {
  ...
  printf("==== RFC7748 Test 1 ==\n");
  times(1, k, 5, x448);
  TEST(memcmp(k, k_1_times, x448->key_size) == 0);
  times(1000, k, 5, x448);
  TEST(memcmp(k, k_1000_times, x448->key_size) == 0);
  // times(1000000,k,5,x448);
  // TEST(memcmp(k, k_1000000_times, x448->key_size)==0);
}
