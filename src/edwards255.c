    ...
    PointXYZT_1way_full *P)
{
    ...
    uint64_t * const X1 = Q->X;
    uint64_t * const X2 = P->X;
    uint64_t * const X3 = R->X;
    uint64_t * const Y1 = Q->Y;
    uint64_t * const Y2 = P->Y;
    uint64_t * const Y3 = R->Y;
    uint64_t * const Z1 = Q->Z;
    uint64_t * const Z2 = P->Z;
    uint64_t * const Z3 = R->Z;
    uint64_t * const T1 = Q->T;
    uint64_t * const T2 = P->T;
    uint64_t * const T3 = R->T;
...
static inline void _2way_fulladd(PointXYZT_2way *Q, PointXYZT_2way *P)
{
    ...
    __m256i * const X2 = P->X;
    __m256i * const Y1 = Q->Y;
    __m256i * const Y2 = P->Y;
    __m256i * const Z1 = Q->Z;
    __m256i * const Z2 = P->Z;
    __m256i * const T1 = Q->T;
    __m256i * const T2 = P->T;
    ...
    Fp25519._2w_red.arithex.intmul(A,X1,X2);
    Fp25519._2w_red.arithex.compress(A);
    Fp25519._2w_red.arithex.intmul(B,Y1,Y2);
    Fp25519._2w_red.arithex.compress(B);
    Fp25519._2w_red.arithex.intmul(C,T1,T2);
    Fp25519._2w_red.arithex.compress(C);
    Fp25519._2w_red.arithex.intmul(C,C,(argElement_2w)param_2d_H0H5);
    Fp25519._2w_red.arithex.compress(C);
    Fp25519._2w_red.arithex.intmul(D,Z1,Z2);
    Fp25519._2w_red.arithex.compress(D);
...
static inline void point_multiplication_fold4w4(uint8_t *rB, uint8_t *r)
{
    ...
    Fp25519._4w_red.arithex.intmul(Q.T,Q.X,Q.Y);
    Fp25519._4w_red.arithex.compress(Q.T);
    Fp25519._4w_red.arithex.intmul(Q.T,Q.T,(argEltFp25519_4w_redradix)one_half);
    Fp25519._4w_red.arithex.compress(Q.T);
