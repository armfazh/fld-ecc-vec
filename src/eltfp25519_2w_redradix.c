    ...
    argElement_2w a, argElement_2w b)
{
    ...
    d[0] = ADD(d[0],SHLV(k0,*sh_0));
    c[0] = ADD(c[0],SHLV(m0,*sh_0));
    d[1] = ADD(d[1],SHLV(k1,*sh_1));
    c[1] = ADD(c[1],SHLV(m1,*sh_1));
    d[2] = ADD(d[2],SHLV(k2,*sh_0));
    c[2] = ADD(c[2],SHLV(m2,*sh_0));
    d[3] = ADD(d[3],SHLV(k3,*sh_1));
    c[3] = ADD(c[3],SHLV(m3,*sh_1));
    d[4] = ADD(d[4],SHLV(k4,*sh_0));
    c[4] = ADD(c[4],SHLV(m4,*sh_0));
}
