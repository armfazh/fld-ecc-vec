...
DECL(void, intmul_mulxadx)(argElement_1w c, argElement_1w a, argElement_1w b) {
  ...
  "mulx  8(%2), %%rax, \\R0;"  "adox %%rax, \\R1;"  "adcx \\R0, \\R2;"  "movq $0, \\R0;"
  "mulx 16(%2), %%rax, \\R0;"  "adox %%rax, \\R2;"  "adcx \\R0, \\R3;"
  "mulx 24(%2), %%rax, \\R0;"  "adox %%rax, \\R3;"  "adcx \\R0, \\R4;"
  "mulx 32(%2), %%rax, \\R0;"  "adox %%rax, \\R4;"  "adcx \\R0, \\R5;"
  "mulx 40(%2), %%rax, \\R0;"  "adox %%rax, \\R5;"  "adcx \\R0, \\R6;"
  "mulx 48(%2), %%rax, \\R0;"  "adox %%rax, \\R6;"  "adcx %%r8, \\R0;"
  /*************************/  "adox  %%r8, \\R0;"
  ".endm;"
  ...
  "MULACC_mulxadx 16, %%r10, %%r11, %%r12, %%r13, %%r14,  %%r8,  %%r9;"
  "MULACC_mulxadx 24, %%r11, %%r12, %%r13, %%r14,  %%r8,  %%r9, %%r10;"
  "MULACC_mulxadx 32, %%r12, %%r13, %%r14,  %%r8,  %%r9, %%r10, %%r11;"
  "MULACC_mulxadx 40, %%r13, %%r14,  %%r8,  %%r9, %%r10, %%r11, %%r12;"
  "MULACC_mulxadx 48, %%r14,  %%r8,  %%r9, %%r10, %%r11, %%r12, %%r13;"
