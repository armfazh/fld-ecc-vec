...
DECL(void, sqrn)(argElement_1w A, unsigned int times)
{
    ...
    for(i=0; i<times; i++) {
        ...
        a2j = ADD(aj, aj);
        c0 = MUL(b0, ai);
        c0 = ADD(c0, MUL(d7, a2j));
        c1 = MUL(b1, a2i);		/*c1 = ADD(c1,MUL(b0, a2j));*/
        c2 = MUL(b2, a2i);
        c2 = ADD(c2, MUL(b1, aj));
        c3 = MUL(b3, a2i);
        c3 = ADD(c3, MUL(b2, a2j));
        c4 = MUL(b4, a2i);
        c4 = ADD(c4, MUL(b3, a2j));
        c5 = MUL(b5, a2i);
        c5 = ADD(c5, MUL(b4, a2j));
        c6 = MUL(b6, a2i);
        c6 = ADD(c6, MUL(b5, a2j));
        c7 = MUL(b7, a2i);
        c7 = ADD(c7, MUL(b6, a2j));
        ...
        a2i = ADD(ai, ai);
        a2j = ADD(aj, aj);
        c0 = ADD(c0, MUL(d6, a2i));
        c0 = ADD(c0, MUL(d5, a2j));
        c1 = ADD(c1, MUL(d7, a2i));
        c1 = ADD(c1, MUL(d6, a2j));
        ...
        c6 = ADD(c6, MUL(b4, a2i));
        c6 = ADD(c6, MUL(b3, aj));
        c7 = ADD(c7, MUL(b5, a2i));
        c7 = ADD(c7, MUL(b4, a2j));
        ...
        c2 = ADD(c2, MUL(d6, a2i));
        c2 = ADD(c2, MUL(d5, aj));
        c3 = ADD(c3, MUL(d7, a2i));
        c3 = ADD(c3, MUL(d6, a2j));
