...
DECL(void, intmul_sb)(argElement_4w C, argElement_4w A, argElement_4w B)
{
    ...
    a2i = ADD(A[2],A[2]);
    d9 = MUL(b9,times19);
    c0 = ADD(c0,MUL(a2i,d9));
    c5 = ADD(c5,MUL(ai, b4));
    c1 = ADD(c1,MUL(ai, b0));
    c6 = ADD(c6,MUL(a2i,b5));
    c2 = ADD(c2,MUL(a2i,b1));
    c7 = ADD(c7,MUL(ai, b6));
    c3 = ADD(c3,MUL(ai, b2));
    c8 = ADD(c8,MUL(a2i,b7));
    c4 = ADD(c4,MUL(a2i,b3));
    c9 = ADD(c9,MUL(ai, b8));
    ...
    a2i = ADD(A[6],A[6]);
    d7 = MUL(b7,times19);
    c0 = ADD(c0,MUL(a2i,d7));
    c5 = ADD(c5,MUL(ai,b2));
    c1 = ADD(c1,MUL(ai,d8));
    c6 = ADD(c6,MUL(a2i,b3));
    c2 = ADD(c2,MUL(a2i,d9));
    c7 = ADD(c7,MUL(ai,b4));
    c3 = ADD(c3,MUL(ai,b0));
    c8 = ADD(c8,MUL(a2i,b5));
    c4 = ADD(c4,MUL(a2i,b1));
    c9 = ADD(c9,MUL(ai,b6));
    ...
    a2i = ADD(A[1],A[1]);
    d5 = MUL(b5,times19);
    c0 = ADD(c0,MUL(a2i,d5));
    c5 = ADD(c5,MUL(ai,b0));
    c1 = ADD(c1,MUL(ai,d6));
    c6 = ADD(c6,MUL(a2i,b1));
    c2 = ADD(c2,MUL(a2i,d7));
    c7 = ADD(c7,MUL(ai,b2));
    c3 = ADD(c3,MUL(ai,d8));
    c8 = ADD(c8,MUL(a2i,b3));
    c4 = ADD(c4,MUL(a2i,d9));
    c9 = ADD(c9,MUL(ai,b4));
    ...
    a2i = ADD(A[5],A[5]);
    d3 = MUL(b3,times19);
    c0 = ADD(c0,MUL(a2i,d3));
    c5 = ADD(c5,MUL(ai,d8));
    c1 = ADD(c1,MUL(ai,d4));
    c6 = ADD(c6,MUL(a2i,d9));
    c2 = ADD(c2,MUL(a2i,d5));
    c7 = ADD(c7,MUL(ai,b0));
    c3 = ADD(c3,MUL(ai,d6));
    c8 = ADD(c8,MUL(a2i,b1));
    c4 = ADD(c4,MUL(a2i,d7));
    c9 = ADD(c9,MUL(ai,b2));
    ...
    a2i = ADD(A[9],A[9]);
    d1 = MUL(b1,times19);
    c0 = ADD(c0,MUL(a2i,d1));
    c5 = ADD(c5,MUL(ai,d6));
    c1 = ADD(c1,MUL(ai,d2));
    c6 = ADD(c6,MUL(a2i,d7));
    c2 = ADD(c2,MUL(a2i,d3));
    c7 = ADD(c7,MUL(ai,d8));
    c3 = ADD(c3,MUL(ai,d4));
    c8 = ADD(c8,MUL(a2i,d9));
    c4 = ADD(c4,MUL(a2i,d5));
    c9 = ADD(c9,MUL(ai,b0));
...
DECL(void, compress2)(argElement_4w C,argElement_4w D)
{
    ...
    __m256i h0,h1,h2,h3,h4,h5,h6,h7,h8,h9;
    __m256i _D_h0,_D_h1,_D_h2,_D_h3,_D_h4,_D_h5,_D_h6,_D_h7,_D_h8,_D_h9;

    h0 = SHR(c0, BASE0_FP25519);
    _D_h0 = SHR(d0, BASE0_FP25519);
    c0 = AND(c0, mask26);
    d0 = AND(d0, mask26);
    c1 = ADD(c1, h0);
    d1 = ADD(d1, _D_h0);
    ...
    h9 = SHR(c9, BASE1_FP25519);
    _D_h9 = SHR(d9, BASE1_FP25519);
    c9 = AND(c9, mask25);
    d9 = AND(d9, mask25);
    c0 = ADD(c0, MUL19(h9));
    d0 = ADD(d0, MUL19(_D_h9));
...
DECL(void, new_compressfast2)(argElement_4w C, argElement_4w D)
{
    ...
    __m256i l0,l1,l2,l3,l4,l5,l6,l7,l8,l9;
    __m256i _D_l0,_D_l1,_D_l2,_D_l3,_D_l4,_D_l5,_D_l6,_D_l7,_D_l8,_D_l9;
    __m256i m0,m1,m2,m3,m4,m5,m6,m7,m8,m9;
    __m256i _D_m0,_D_m1,_D_m2,_D_m3,_D_m4,_D_m5,_D_m6,_D_m7,_D_m8,_D_m9;

    m0 = SHR(c0, BASE0_FP25519);
    _D_m0 = SHR(d0, BASE0_FP25519);
    m1 = SHR(c1, BASE1_FP25519);
    _D_m1 = SHR(d1, BASE1_FP25519);
    m2 = SHR(c2, BASE0_FP25519);
    _D_m2 = SHR(d2, BASE0_FP25519);
    m3 = SHR(c3, BASE1_FP25519);
    _D_m3 = SHR(d3, BASE1_FP25519);
    m4 = SHR(c4, BASE0_FP25519);
    _D_m4 = SHR(d4, BASE0_FP25519);
    m5 = SHR(c5, BASE1_FP25519);
    _D_m5 = SHR(d5, BASE1_FP25519);
    m6 = SHR(c6, BASE0_FP25519);
    _D_m6 = SHR(d6, BASE0_FP25519);
    m7 = SHR(c7, BASE1_FP25519);
    _D_m7 = SHR(d7, BASE1_FP25519);
    m8 = SHR(c8, BASE0_FP25519);
    _D_m8 = SHR(d8, BASE0_FP25519);
    m9 = SHR(c9, BASE1_FP25519);
    _D_m9 = SHR(d9, BASE1_FP25519);
    ...
    c0 = ADD(l0,MUL(m9,times19));
    d0 = ADD(_D_l0,MUL(_D_m9,times19));
    c1 = ADD(l1,m0);
    d1 = ADD(_D_l1,_D_m0);
    c2 = ADD(l2,m1);
    d2 = ADD(_D_l2,_D_m1);
