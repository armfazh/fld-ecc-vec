...
static inline void join_points_2w_H0H8(PointXYZT_2w_H0H8 *R0, PointXYZT_4way_Fp448 *Q)
{
    ...
    Fp448._2w_red.arithex.inter(R0->XY, Q0.X, Q0.Y);
    Fp448._2w_red.arithex.inter(R0->TZ, Q0.T, Q0.Z);
    Fp448._2w_red.arithex.inter(R1.XY, Q1.X, Q1.Y);
    Fp448._2w_red.arithex.inter(R1.TZ, Q1.T, Q1.Z);
    Fp448._2w_red.arithex.inter(R2.XY, Q2.X, Q2.Y);
    Fp448._2w_red.arithex.inter(R2.TZ, Q2.T, Q2.Z);
    Fp448._2w_red.arithex.inter(R3.XY, Q3.X, Q3.Y);
    Fp448._2w_red.arithex.inter(R3.TZ, Q3.T, Q3.Z);
