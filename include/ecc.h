...
typedef ALIGN struct point_precompute_2way{
    Element_2w_H0H8 addYX;
	Element_2w_H0H8 subYX;
	Element_2w_H0H8 _2dYX;
} Point_precmp_2way;
...
typedef ALIGN struct point_precompute_4way{
    Element_4w_H0H8 addYX;
	Element_4w_H0H8 subYX;
	Element_4w_H0H8 _2dYX;
} Point_precmp_4way;
...
typedef ALIGN struct pointxytz_precompute_2w_h0h8{
	Element_2w_H0H8 subaddYX;
	Element_2w_H0H8 _2dT_2Z;
