...
#define ADD32_128(X,Y)      _mm_add_epi32(X,Y)
#define ADD64_128(X,Y)      _mm_add_epi64(X,Y)
#define XOR_128(X,Y)        _mm_xor_si128(X,Y)
#define OR_128(X,Y)         _mm_or_si128(X,Y)
#define SHL32_128(X,Y)      _mm_slli_epi32(X,Y)
#define SHR32_128(X,Y)      _mm_srli_epi32(X,Y)
#define SHL64_128(X,Y)      _mm_slli_epi64(X,Y)
#define SHR64_128(X,Y)      _mm_srli_epi64(X,Y)
#define SHUF8_128(X,Y)      _mm_shuffle_epi8(X,Y)
#define SET1_64_128(X)	    _mm_set1_epi64x(X)
 ...
 */
#define BROADCAST32_128(X,Y)	__asm__ __volatile(\
"vpbroadcastd (%1), %0       ;"\
:/* out  */ "=x" (X)\
:/* in   */ "r" (Y)\
:/* regs */);
...
#define ADD32_256(X,Y)      _mm256_add_epi32(X,Y)
#define ADD64_256(X,Y)      _mm256_add_epi64(X,Y)
#define XOR_256(X,Y)        _mm256_xor_si256(X,Y)
#define OR_256(X,Y)         _mm256_or_si256(X,Y)
#define SHL32_256(X,Y)      _mm256_slli_epi32(X,Y)
#define SHR32_256(X,Y)      _mm256_srli_epi32(X,Y)
#define SHL64_256(X,Y)      _mm256_slli_epi64(X,Y)
#define SHR64_256(X,Y)      _mm256_srli_epi64(X,Y)
#define SHUF8_256(X,Y)      _mm256_shuffle_epi8(X,Y)
#define SET1_64_256(X)	    _mm256_set1_epi64x(X)
...
ALIGN static const uint64_t KSHA512[80] =
{
